...
import org.apache.eventmesh.dashboard.agent.config.handler.RocketMQNameSerivceConfigHandler;
...
public class ConfigHandlerManage {
    ...
    {
        this.configHandlerMap.put("", RocketMQNameSerivceConfigHandler.class);
    }
