...
public class MetadataSyncManage {
    ...
    public class MetadataSyncWrapper implements Runnable {
        ...
        public void syncClusterData() {
            try {
                List<MetadataConfig> metadataConfigList = this.metadataSyncConfig.clusterService.getData();
        ...
        public void syncDatabasesData() {
            try {
                List<MetadataConfig> metadataConfigList = this.metadataSyncConfig.dataBasesHandler.getData();
