...
/** Independent metric families; failed futures represent missing observations. */
public interface MetricsRemotingService {
    Map<String, CompletableFuture<List<MetricSample>>> collectAsync(MetricFamily family, long deadlineMillis);

    CompletableFuture<GetClientsResult> getClientListAsync();

    CompletableFuture<GetOffsetResult> getOffsetAsync(GetOffsetRequest request);
}
