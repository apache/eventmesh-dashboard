...
public class RegistryEntity2MetadataConverter implements Converter<MetaEntity, RegistryMetadata> {

    @Override
    public RegistryMetadata convert(MetaEntity source) {
        return RegistryMetadata.builder()
            .host(source.getHost())
            .port(source.getPort())
            .role(source.getRole())
    ...
    @Override
    public String getUnique(MetaEntity source) {
