...
/** 客户端最近一分钟消费成功 TPS，消息数每秒。 */
@Data
@EqualsAndHashCode(callSuper = true)
@ReportMeta(clusterType = ClusterType.STORAGE_ROCKETMQ, reportName = "rocketmq_consumer_success_tps",
    defaultViewType = ReportViewType.GAUGE, tableName = "rocketmq_consumer_success_tps",
    comment = "客户端最近一分钟消费成功 TPS，消息数每秒")
public class RocketmqConsumerSuccessTps extends RuntimeFloatValue {
