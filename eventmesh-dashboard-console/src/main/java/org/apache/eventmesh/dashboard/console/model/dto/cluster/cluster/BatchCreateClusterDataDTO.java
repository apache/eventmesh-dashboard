...
@Data
public class BatchCreateClusterDataDTO extends OrganizationIdDTO {
    ...
    /**
     * 不会接受 与 clusterTrusteeshipType 字段
     */
    private List<SimpleCreateClusterDataDTO> simpleCreateClusterDataList;
