 ...
 */
@Mapper
public interface NetConnectionMetaData extends ConvertMetaData<NetConnectionEntity, NetConnectionMetadata> {

    NetConnectionMetaData INSTANCE = Mappers.getMapper(NetConnectionMetaData.class);

    @Override
    NetConnectionEntity toEntity(NetConnectionMetadata meta);

    @Override
    NetConnectionMetadata toMetaData(NetConnectionEntity entity);
}
