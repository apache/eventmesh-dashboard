...
public class ConnectionMetadata2EntityConverter implements Converter<ConnectionMetadata, ConnectionEntity> {

    @Override
    public ConnectionEntity convert(ConnectionMetadata source) {
        return ConnectionEntity.builder()
            .clusterId(source.getClusterId())
            .status(1)
            .sinkId(source.getSinkId())
            .sourceId(source.getSourceId())
            .sourceType(source.getSourceType())
            .sinkId(source.getSinkId())
            .sinkType(source.getSinkType())
            .runtimeId(source.getRuntimeId())
            .status(1)
    ...
    @Override
    public String getUnique(ConnectionMetadata source) {
        return null;
    }
