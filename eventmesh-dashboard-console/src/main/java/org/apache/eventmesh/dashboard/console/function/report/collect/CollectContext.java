...
/** Immutable time boundary for one target observation. */
@Value
public class CollectContext {
    ...
    public static CollectContext now(MetricFamily family) {
        return new CollectContext(family, LocalDateTime.now(), System.currentTimeMillis() + 4000);
    }
}
