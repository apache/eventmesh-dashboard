...
public class RuntimeEntity2MetadataConverter implements Converter<RuntimeEntity, RuntimeMetadata> {

    @Override
    public RuntimeMetadata convert(RuntimeEntity source) {
        return RuntimeMetadata.builder()
            .host(source.getHost())
            .port(source.getPort())
    ...
    @Override
    public String getUnique(RuntimeEntity source) {
