...
/** Native resource names are scoped to runtime; no synthetic MySQL resource IDs. */
@Data
@EqualsAndHashCode(callSuper = true)
@ReportMeta(clusterType = ClusterType.STORAGE_ROCKETMQ, reportName = "rocketmq_broker_sample",
    defaultViewType = ReportViewType.GAUGE, tableName = "rocketmq_broker_sample", comment = "Broker observations")
public class RocketmqBrokerSample extends RuntimeId {
