 ...
 */
@Mapper
public interface GroupMemberConvertMetaData extends ConvertMetaData<GroupMemberEntity, GroupMemberMetadata> {

    GroupMemberConvertMetaData INSTANCE = Mappers.getMapper(GroupMemberConvertMetaData.class);

    @Override
    GroupMemberEntity toEntity(GroupMemberMetadata meta);

    @Override
    GroupMemberMetadata toMetaData(GroupMemberEntity entity);
}
