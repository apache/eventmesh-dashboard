...
(
    ...
    `eventmesh_address` varchar(192)     NOT NULL DEFAULT '' COMMENT 'eventmesh地址',
    ...
    `status`            int(16) unsigned NOT NULL DEFAULT '0' COMMENT '状态: 1启用，0未启用',
...
(
    ...
    `source_status` int(16)     NOT NULL DEFAULT '0' COMMENT 'source状态: 1启用，0未创建',
    ...
    `sink_status`    int(16)     NOT NULL DEFAULT '0' COMMENT 'sink状态: 1启用，0未创建',
    `runtime_id`      bigint(20)          NOT NULL DEFAULT '-1' COMMENT '对应runtime id',
    `status`          int(16)     NOT NULL DEFAULT '0' COMMENT '状态: 1启用，0未启用',
...
(
    ...
    `cluster_phy_id`       bigint(20)          NOT NULL DEFAULT '-1' COMMENT '物理集群ID',
    `connector_cluster_id` bigint(20)          NOT NULL COMMENT '连接器集群ID',
    `runtime_cluster_id`   bigint(20)          NOT NULL COMMENT '运行时集群ID',
    `storage_cluster_id`   bigint(20)          NOT NULL COMMENT '存储集群ID',
